...
//        UIImage* backItemHlImage = [[UIImage imageNamed:@"backItemImage-hl"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        UIImage *backItemImage = [[UIImage imageNamed:@"back_icon"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
...
- (UIProgressView *)progressView{
    if (!_progressView) {
        ...
        _progressView.progressTintColor = [UIColor colorWithRed:124.0/255.0 green:103.0/255.0 blue:82.0/255.0 alpha:1.0];
    }
